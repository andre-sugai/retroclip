...
# Mapping of artists to genres for 1964
genre_mapping = {
    "The Beatles": "Pop",
    "Trio Irakitan": "Pop"  # Brazilian folk/traditional music
}
...
try:
    with open('data/1964.json', 'r', encoding='utf-8-sig') as f:
        data = json.load(f)
except:
    with open('data/1964.json', 'r') as f:
        data = json.load(f)
...
# Save back to file
with open('data/1964.json', 'w') as f:
