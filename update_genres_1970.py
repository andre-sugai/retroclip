...
# Mapping of artists to genres for 1970
genre_mapping = {
    "The Jackson 5": "Pop",
    "Bee Gees": "Pop",
    "John Lennon": "Rock Alternativo",
    "Creedence Clearwater Revival": "Rock Alternativo",
...
try:
    with open('data/1970.json', 'r', encoding='utf-8-sig') as f:
        data = json.load(f)
except:
    with open('data/1970.json', 'r') as f:
        data = json.load(f)
...
# Save back to file
with open('data/1970.json', 'w') as f:
