              ...
              <div className="pt-4 border-t border-border">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={tech}
                      className="px-2 py-1 bg-zinc-100 dark:bg-zinc-800 rounded text-[10px] font-mono border border-zinc-200 dark:border-zinc-700"
                    >
                      {tech}
                    </span>
                  ))}
              ...
              <div className="pt-4 border-t border-border">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    onClick={() =>
                      window.open('https://github.com/andresugai', '_blank')
                    }
                  >
                  ...
                  <Button
                    ...
                    className="h-8 text-xs gap-2"
                    onClick={() =>
                      window.open('https://andresugai.com', '_blank')
                    }
                  >
