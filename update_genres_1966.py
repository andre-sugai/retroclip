...
# Mapping of artists to genres for 1966
genre_mapping = {
    "The Beatles": "Pop", # Rock/Pop
    "The Beach Boys": "Pop", # Surf Rock / Pop
    "The Monkees": "Pop", # Pop Rock
    "The Who": "Rock Alternativo" # Rock
}
...
# Save back to file
with open('data/1966.json', 'w') as f:
